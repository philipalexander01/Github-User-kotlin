package com.example.githubusers2.alarm
...
import com.example.githubusers2.ui.MainActivity
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, message: String) {
        ...
        Toast.makeText(
            context,
            context.getString(R.string.start_repeating_alarm),
            Toast.LENGTH_SHORT
        ).show()
    }
    ...
    fun cancelAlarm(context: Context) {
        ...
        Toast.makeText(
            context,
            context.getString(R.string.cancel_repeating_alarm),
            Toast.LENGTH_SHORT
        ).show()
    }
